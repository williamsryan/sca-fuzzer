"""
TODO: this will be the parametric contract executor class.
Purpose of this is to have a way to execute a test case
with a contract (and not need to run on a kernel).
"""
